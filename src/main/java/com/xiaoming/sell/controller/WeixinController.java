...
public class WeixinController {
    ...
    public void auth(@RequestParam("code") String code) {
        log.info("进入auth方法");
        log.info("code={}", code);
        String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wxa8bc333b091de205&secret=472dec8404f0aca4091dee3c839bb133&code="+code+"&grant_type=authorization_code";
